...
class _CreateNewTripScreenState extends State<CreateNewTripScreen> {
  ...
  static const String _chamMuseumAsset =
      'assets/images/create_new_trip/d71237a5361fac18bae734ec580522bee9c8b09a.jpg';
  static const String _myKheBeachAsset =
      'assets/images/create_new_trip/3c81e523d054dd0f67c96d6c7dc0d797c5c12c40.jpg';
  ...
  Future<void> _openLanguageSelector() async {
    final tempSelection = {..._selectedLanguages};
    final result = await showModalBottomSheet<Set<String>>(
      context: context,
      builder: (context) {
        const languages = ['Korean', 'English', 'Vietnamese', 'Japanese'];
                  ...
                  children: [
                    const Text(
                      ...
                      style: TextStyle(
                        ...
                        color: CreateNewTripScreen.textPrimary,
                      ),
                    ),
                    ...
                    ...languages.map((language) {
                      ...
                      return CheckboxListTile(
                        ...
                        activeColor: CreateNewTripScreen.primary,
                        title: Text(language),
                        value: selected,
                        onChanged: (_) {
                          setSheetState(() {
  ...
  String get _languageLabel => _selectedLanguages.join(', ');
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const _TripLine(
                      ...
                      labelColor: CreateNewTripScreen.textPrimary,
                    ),
                    ...
                    _TripLine(
                      ...
                      labelColor: _selectedDate == null
                          ? CreateNewTripScreen.textSecondary
                          : CreateNewTripScreen.textPrimary,
                      onTap: _pickDate,
                    ),
                    const SizedBox(height: 22),
                    const Text(
                    ...
                    const SizedBox(height: 8),
                    _FeeLine(controller: _feeController),
                    const SizedBox(height: 22),
                    const Text(
                      "Guide's Language",
                      style: TextStyle(
                    ...
                    if (_customAttractions.isNotEmpty) ...[
                      ...
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: _customAttractions.map((item) {
                          return Container(
...
class _TripLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        decoration: const BoxDecoration(
          border: Border(bottom: BorderSide(color: CreateNewTripScreen.border)),
        ),
...
class _AssetTripLine extends StatelessWidget {
  const _AssetTripLine({
...
class _FeeLine extends StatelessWidget {
  const _FeeLine({required this.controller});
          ...
          Expanded(
            child: TextField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'Fee',
                hintStyle: TextStyle(color: CreateNewTripScreen.textSecondary),
                isDense: true,
